...
#     screw_pitch = 2.0
    ...
    # Initialize floor demo flags
    rope_command_flag = False # indicates whether or not to command taut rope stiffness goals
    cancel_command_flag = False # Indicates whether or not to cancel goals
...
while not m.get_button_state(1):
    ...
    # Check when end-effector pulls the rop taut, for rope demo
        ...
        if np.linalg.norm(ee_pose_curr[0:3, 3] - anchor_point) >= rope_length and rope_command_flag:
            ...
            # Update flags to indicate rope being pulled taut
            rope_command_flag = False
            cancel_command_flag = True
        ...
        # Cancel goal if end-effector makes the rope slack, only when it begins to slacken
            ...
            # Update flags to indicate rope slackening
            cancel_command_flag = False
            rope_command_flag = True
