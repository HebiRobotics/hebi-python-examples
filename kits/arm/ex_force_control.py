...
while not m.get_button_state(1):
    ...
    if controller_on and mode == Mode.BALL_ON_FLOOR:
    ...
    elif controller_on and mode == Mode.ROPE:
    ...
    elif controller_on and mode == Mode.WEIGHT:
    ...
    # elif controller_on and mode == Mode.BOOK:
