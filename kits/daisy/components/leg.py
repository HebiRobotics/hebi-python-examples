...
class Leg:
  ...
  def track_trajectory(self, t, trajectory, gravity, foot_force):
    """
    Follows the provided trajectory, while additionally compensating for gravity and ground forces
    """
  ...
  def get_state_at_time(self, t):
    """
    Used to determine calculated positions and velocities without sending them to the modules
    """
    kin = self._kinematics
