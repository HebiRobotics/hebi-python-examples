...
class JoystickEvent(object):
    ...
    This also holds callbacks to respond to this event. Additionally,
    this acts as a condition variable, providing mutual exclusion to
    this event.
    """
...
class Joystick(object):
    """Represents a joystick input device. This class is used to receive input
    events from the user. Both asynchronous and synchronous facilities are
    exposed.
    ...
    def get_axis(self, axis):
        """Retrieves the last value of the axis provided. This call does not
        block.
    ...
    def get_next_button_state(self, button, timeout=None):
        ...
        an sdl2.<button down> or sdl2.<button up> event has been received for
        the button.
